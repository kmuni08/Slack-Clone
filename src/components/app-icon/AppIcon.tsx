...
import { svg, path } from './variants.motion';
import { Theme, ThemeDark, ThemeLight } from '../../interfaces';

const AppIcon: FunctionComponent<{ theme?: Theme }> = ({ theme = ThemeDark }) => {
  return (
    <motion.svg
      variants={svg[theme]} initial={'hidden'} animate={'visible'}
      xmlns="http://www.w3.org/2000/svg" shapeRendering="geometricPrecision" viewBox="0 0 240 60" width="100"
      height="25" aria-label="Slack" className="c-slacklogo--white svg-replaced">
      <motion.path
        variants={path}
        ...
        fill={theme === ThemeLight ? '#000000' : '#FFFFFF'}/>
      <motion.path
        variants={path}
